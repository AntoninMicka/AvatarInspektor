...
const sections = {
  identity: [
    ...
    {
      key: 'profile_name_detected',
      label: 'Jmeno profilu rozpoznano',
      source: 'automatic',
    },
    {
      key: 'profile_photo_detected',
      label: 'Profilova fotka nalezena',
      source: 'automatic',
    },
    {
      key: 'account_history_detected',
      label: 'Historie profilu zachycena',
      source: 'automatic',
    },
  ],
  photos: [
    {
      key: 'profile_photo_analyzed',
      label: 'Profilova fotka analyzovana',
      source: 'automatic',
    },
    {
      key: 'photo_low_resolution',
      label: 'Nizke rozliseni',
      source: 'automatic',
      negative: true,
    },
    {
      key: 'photo_external_source',
      label: 'Externi nebo komercni zdroj',
      source: 'automatic',
      negative: true,
    },
    {
      key: 'photo_metadata_present',
      label: 'Metadata pritomna',
      source: 'automatic',
    },
    {
      key: 'photo_screenshot_like',
      label: 'Pripomina screenshot',
      source: 'automatic',
      negative: true,
    },
    {
      key: 'photo_heavily_compressed',
      label: 'Silne komprimovana fotka',
      source: 'automatic',
      negative: true,
    },
    {
      key: 'photo_copyright_metadata',
      label: 'Autorska metadata',
      source: 'automatic',
      negative: true,
    },
    {
      key: 'photo_avatar_crop_like',
      label: 'Rozmery jako avatar',
      source: 'automatic',
    },
  ],
  social: [
    {
      key: 'social_graph_available',
      label: 'Socialni vazby zachyceny',
      source: 'automatic',
    },
    {
      key: 'location_hints_detected',
      label: 'Nalezene geograficke stopy',
      source: 'automatic',
    },
    {
...
function renderProfile(profile) {
  ...
  photoStatus.textContent =
    profile.photoAnalysis?.verdict || 'Fotka zatim nebyla analyzovana.';
...
function buildProfileSummary(profile) {
  const manualFlags = Object.values(profile.manualChecks || {}).filter(
    Boolean
  ).length;
  const automaticFlags = Object.values(profile.automaticChecks || {}).filter(
    Boolean
  ).length;
...
function renderResultHeader(assessment) {
  ...
  resultSummary.textContent =
    assessment?.summary ||
    'Vysledek analyzy se zobrazi po zpracovani profilove fotky.';
